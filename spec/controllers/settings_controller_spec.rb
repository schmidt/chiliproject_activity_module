...
describe SettingsController do
  ...
  describe 'edit' do
    ...
    it 'contains a check box for the activity module on the projects tab' do
      ...
      response.should have_tag "input[name='settings[default_projects_modules][]'][value=activity]"
    end
    ...
    describe 'with activity in Setting.default_projects_modules' do
      ...
      it 'contains a checked checkbox for activity' do
        ...
        response.should have_tag "input[name='settings[default_projects_modules][]'][value=activity][checked=checked]"
      end
    end
    ...
    describe 'without activated activity module' do
      ...
      it 'contains an unchecked checkbox for activity' do
        ...
        response.should_not have_tag "input[name='settings[default_projects_modules][]'][value=activity][checked=checked]"
      end
    end
  end
end
